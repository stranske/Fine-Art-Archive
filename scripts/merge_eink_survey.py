...
NOT_A_VENDOR = (
    "assorted marketplace", "known vendors encountered", "unnamed epia member",
    "other named-but-upstream", "not individually verified",
    "epaper industry alliance", "e-paper industry alliance",
